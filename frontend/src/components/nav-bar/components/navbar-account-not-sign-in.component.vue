<template>
	<mz-dropdown-menu slot="dropdown"
	                  class="nav-bar-account-not-sign-in">

		<div class="separator">{{$t(`navBar.manage`)}}</div>

		<mz-dropdown-item class="nav-bar-account-not-sign-in__item">
...
<script lang="ts">
    ...
    export default class mzNavBarAccountNotSignIn extends Vue {
    };
