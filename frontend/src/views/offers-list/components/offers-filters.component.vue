<template>
  <mz-collapse class="mz-offers-filters"
               v-model="activeNames">

    <mz-collapse-item :title="$t(`filters.title`)"
                      name="0"
                      class="mz-offers-filters__collapse">

      <div class="mz-offers-filters__category">
      ...
      <div class="mz-offers-filters__target-group">
      ...
      <div class="mz-offers-filters__tags">
        <p class="title">{{ $t(`filters.tags.title`) }}</p>

        <mz-input v-model="itemTag"
                  :holder="$t(`filters.tags.addTags`)"
                  id="itemTag"
                  class="mz-offers-filters__tags__input"
                  @keyup.enter.native="addTag(itemTag)" />

        <div class="mz-offers-filters__tags__add-btn"
             @click="addTag(itemTag)">

          +
        </div>

        <div class="mz-offers-filters__tags__list">
...
import { IFilters }       from '@/views/offers-list/store/offers-list.interface';
...
export default class mzOffersFilters extends Vue {
  @local.State((state: mzOffersListModule) => state.mzOffersList.filters) public filters!: IFilters;
