<template>
    <div class="mz-login-views">
        <mz-logo :is-green="false" class="mz-login-views__logo"/>
        ...
        <div class="mz-login-views__box">
            ...
            <mz-form class="mz-login-view__box__form"
        ...
        <mz-footer :is-light="true"
                   class="mz-login-views__footer"></mz-footer>

        <mz-social-media :is-light="true" class="mz-login-views__social-media"/>
    </div>
</template>
